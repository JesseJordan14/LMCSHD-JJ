...
- [x] **Feature 5: Built-in test patterns**
  - [x] Solid color (color picker + Fill / Clear)
  - [x] Walking pixel (one LED at a time, in chain order)
  - [x] Per-section color (each section gets a distinct color so you can see which physical panel is which)
